...
namespace SqlSugar
{
    ...
    public class JsonConverter
    {
        ...
        /// <summary>
        /// DataTable 转为 dynamic集合
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
        public static List<dynamic> ConvertDataTable(DataTable dt)
        {
            return GetDynamicByDataTable(dt);
        ...
        /// <param name="dt"></param>
        /// <returns></returns> 
        public static List<dynamic> GetDynamicByDataTable(DataTable dt)
        {
            ...
            foreach (DataRow Row in dt.Rows)
            {
                ...
                {
                    (d as System.Collections.Generic.ICollection<System.Collections.Generic.KeyValuePair<string, object>>).Add(new System.Collections.Generic.KeyValuePair<string, object>(cl.ColumnName, Row[cl.ColumnName].ToString()));
                }
                list.Add(d);
            }
            return list;
